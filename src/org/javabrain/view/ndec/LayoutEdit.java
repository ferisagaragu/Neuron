 ...
 */
public class LayoutEdit extends javax.swing.JDialog {

    public LayoutEdit(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        extensionFld.setText(org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.extensionFld.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.jLabel2.text")); // NOI18N

        specialCheck.setBackground(new java.awt.Color(255, 255, 255));
        org.openide.awt.Mnemonics.setLocalizedText(specialCheck, org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.specialCheck.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(importLbl, org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.importLbl.text")); // NOI18N
        importLbl.setEnabled(false);

        importClassFld.setText(org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.importClassFld.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(declarationLbl, org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.declarationLbl.text")); // NOI18N
        declarationLbl.setEnabled(false);

        classFld.setText(org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.classFld.text")); // NOI18N
        classFld.setEnabled(false);

        org.openide.awt.Mnemonics.setLocalizedText(keyLbl, org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.keyLbl.text")); // NOI18N
        keyLbl.setEnabled(false);

        declarationFld.setText(org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.declarationFld.text")); // NOI18N
        declarationFld.setEnabled(false);

        messageLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/info.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(messageLbl, org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.messageLbl.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(breackLbl, org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.breackLbl.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(cancelBtn, org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.cancelBtn.text")); // NOI18N
        cancelBtn.setContentAreaFilled(false);

        okBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/edit.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(okBtn, org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.okBtn.text")); // NOI18N
        okBtn.setContentAreaFilled(false);

        errorLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/err.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(errorLbl, org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.errorLbl.text")); // NOI18N

        toStringCheck.setBackground(new java.awt.Color(255, 255, 255));
        org.openide.awt.Mnemonics.setLocalizedText(toStringCheck, org.openide.util.NbBundle.getMessage(LayoutEdit.class, "LayoutEdit.toStringCheck.text")); // NOI18N
        toStringCheck.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                toStringCheckActionPerformed(evt);
            }
        });
    ...
    public void toStringCheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_toStringCheckActionPerformed
        if (toStringCheck.isSelected()) {
            messageLbl.setText("<html><p style=\"color:#3F51B5;\"><b>Statement example:</b></p><p style=\"color:#3F51B5;\"><b>OBJECT ${key} = new <br>OBJECT(\"${value} -> THIS THE CONTENT FILE TEXT\");</b></p></html>");
        } else {
            messageLbl.setText("<html><p style=\"color:#3F51B5;\"><b>Statement example:</b></p><p style=\"color:#3F51B5;\"><b>OBJECT ${key} = new OBJECT(\"${value}\");</b></p></html>");
        }
    }//GEN-LAST:event_toStringCheckActionPerformed
    ...
    public void setToStringCheck(boolean toStringCheck) {
        this.toStringCheck.setSelected(toStringCheck);
    }
