 ...
 */
public class RawNew extends javax.swing.JDialog {

    public RawNew(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        extensionFld.setText(org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.extensionFld.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.jLabel2.text")); // NOI18N

        specialCheck.setBackground(new java.awt.Color(255, 255, 255));
        org.openide.awt.Mnemonics.setLocalizedText(specialCheck, org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.specialCheck.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(importLbl, org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.importLbl.text")); // NOI18N
        importLbl.setEnabled(false);

        importClassFld.setText(org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.importClassFld.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(declarationLbl, org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.declarationLbl.text")); // NOI18N
        declarationLbl.setEnabled(false);

        classFld.setText(org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.classFld.text")); // NOI18N
        classFld.setEnabled(false);

        org.openide.awt.Mnemonics.setLocalizedText(keyLbl, org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.keyLbl.text")); // NOI18N
        keyLbl.setEnabled(false);

        declarationFld.setText(org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.declarationFld.text")); // NOI18N
        declarationFld.setEnabled(false);

        messageLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/info.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(messageLbl, org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.messageLbl.text")); // NOI18N
        messageLbl.setEnabled(false);

        org.openide.awt.Mnemonics.setLocalizedText(breackLbl, org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.breackLbl.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(cancelBtn, org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.cancelBtn.text")); // NOI18N
        cancelBtn.setContentAreaFilled(false);

        okBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/ok.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(okBtn, org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.okBtn.text")); // NOI18N
        okBtn.setContentAreaFilled(false);

        errorLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/err.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(errorLbl, org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.errorLbl.text")); // NOI18N

        toStringCheck.setBackground(new java.awt.Color(255, 255, 255));
        org.openide.awt.Mnemonics.setLocalizedText(toStringCheck, org.openide.util.NbBundle.getMessage(RawNew.class, "RawNew.toStringCheck.text")); // NOI18N
